...
def parse_idp_test_pdf(test_idx):
    ...
    for p_num, sec_text in sections:
        ...
        for q_num in range(q_start_n, q_end_n + 1):
            ...
            q_type = "SHORT_ANSWER"
            if c_ans in ["TRUE", "FALSE", "NOT GIVEN"]:
                q_type = "TRUE_FALSE_NOT_GIVEN"
            elif c_ans in ["YES", "NO"]:
                q_type = "YES_NO_NOT_GIVEN"
            elif re.match(r'^(i|ii|iii|iv|v|vi|vii|viii|ix|x)$', c_ans, re.I):
                q_type = "MATCHING_HEADINGS"
            elif re.match(r'^[A-H]$', c_ans):
        ...
        print(f"Processed Test {test_idx:02d} Passage {p_num}")

print("=== Processing Test 5 to Test 34 ===")
for t in range(5, 35):
    parse_idp_test_pdf(t)
print("Finished accurate extraction for Test 5 to Test 34!")
