...
Season 2/[1]The.Wheel.of.Time.S02E05.1080p.WEB.H264-NHTFS.srt
"""
...
SRT_SOURCE = SEASON_2_DIR / "[1]The.Wheel.of.Time.S02E05.1080p.WEB.H264-NHTFS.srt"
ASS_OUTPUT_NAME_MKV = SEASON_2_DIR / "The Wheel of Time - S02E05 - Damane.ass"
EN_ASS_OUTPUT_MKV = SEASON_2_DIR / "The Wheel of Time - S02E05 - Damane.en.ass"
ASS_OUTPUT_SRT_NAME = SEASON_2_DIR / "[1]The.Wheel.of.Time.S02E05.1080p.WEB.H264-NHTFS.ass"

CACHE_JSON = CACHE_DIR / "The Wheel of Time - S02E05 - Damane_trans.json"
...
def srt_time_to_ass(srt_time_str):
    # srt: 00:00:06,382 -> ass: 0:00:06.38
...
def translate_batch_gtx(items):
    """
    items: list of (idx, text)
    returns dict {idx: translated_text}
    """
    ...
    for i in range(0, len(to_query), batch_size):
        ...
        for attempt in range(3):
            try:
                ...
                # Check if all items in chunk are resolved
...
def main():
    print(f"🎬 Processing S02E05 Subtitles...")
    ...
    print(f"\n🎉 HOÀN TẤT TẠO FILE ASS SONG NGỮ CHO TẬP S02E05!")
