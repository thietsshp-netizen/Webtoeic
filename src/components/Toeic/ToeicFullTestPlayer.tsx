...
export default function ToeicFullTestPlayer({
  ...
  const getListeningScore = (correct: number) => {
    ...
    const table: Record<number, number> = {
      95: 490, 94: 485, 93: 480, 92: 475, 91: 470,
      90: 465, 89: 460, 88: 455, 87: 450, 86: 445,
      85: 440, 84: 430, 83: 420, 82: 410, 81: 400,
      80: 395, 79: 390, 78: 385, 77: 380, 76: 375,
      75: 370, 74: 365, 73: 360, 72: 355, 71: 350,
      70: 345, 69: 340, 68: 335, 67: 330, 66: 325,
      65: 320, 64: 315, 63: 310, 62: 305, 61: 300,
      60: 295, 59: 290, 58: 285, 57: 280, 56: 275,
      55: 270, 54: 265, 53: 260, 52: 255, 51: 250,
      50: 240, 49: 235, 48: 230, 47: 225, 46: 220,
      45: 215, 44: 210, 43: 200, 42: 190, 41: 180,
      40: 175, 39: 170, 38: 165, 37: 160, 36: 155,
      35: 150, 34: 145, 33: 140, 32: 135, 31: 130,
      30: 120, 29: 115, 28: 110, 27: 105, 26: 100,
      25: 95, 24: 90, 23: 85, 22: 80, 21: 75,
      20: 70, 19: 65, 18: 60, 17: 55, 16: 50,
      15: 45, 14: 40, 13: 35, 12: 30, 11: 25,
      10: 20, 9: 20, 8: 15, 7: 15, 6: 10,
      5: 10, 4: 10, 3: 5, 2: 5, 1: 5, 0: 5
    };
    return table[correct] ?? 5;
  };

  const getReadingScore = (correct: number) => {
    if (correct >= 99) return 495;
    const table: Record<number, number> = {
      98: 490, 97: 485, 96: 480,
      95: 475, 94: 470, 93: 465, 92: 460, 91: 455,
      90: 440, 89: 435, 88: 430, 87: 425, 86: 420,
      85: 415, 84: 410, 83: 405, 82: 400, 81: 395,
      80: 390, 79: 385, 78: 380, 77: 375, 76: 370,
      75: 365, 74: 360, 73: 355, 72: 350, 71: 345,
      70: 340, 69: 335, 68: 330, 67: 325, 66: 320,
      65: 315, 64: 310, 63: 305, 62: 300, 61: 295,
      60: 290, 59: 285, 58: 280, 57: 275, 56: 270,
      55: 265, 54: 260, 53: 255, 52: 250, 51: 245,
      50: 230, 49: 225, 48: 220, 47: 215, 46: 210,
      45: 200, 44: 195, 43: 190, 42: 185, 41: 180,
      40: 170, 39: 165, 38: 160, 37: 155, 36: 150,
      35: 140, 34: 135, 33: 130, 32: 125, 31: 120,
      30: 115, 29: 110, 28: 105, 27: 100, 26: 95,
      25: 90, 24: 85, 23: 80, 22: 75, 21: 70,
      20: 65, 19: 60, 18: 55, 17: 50, 16: 45,
      15: 40, 14: 40, 13: 35, 12: 35, 11: 30,
      10: 25, 9: 25, 8: 20, 7: 20, 6: 15,
      5: 15, 4: 15, 3: 10, 2: 10, 1: 5, 0: 5
    };
    return table[correct] ?? 5;
  };
  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 overflow-hidden relative">
      ...
      {mounted && document.getElementById("header-extra-portal") && createPortal(
        <div
          id="full-test-part-timer-target"
          className="flex items-center bg-slate-50/50 rounded-xl border border-slate-200/50 backdrop-blur-md overflow-x-auto scrollbar-none"
          style={{
            maxWidth: '100%',
            height: 'clamp(20px, 3.2vh, 32px)',
            padding: 'clamp(1px, 0.3vh, 3px) clamp(2px, 0.8vw, 8px)',
            gap: 'clamp(2px, 0.8vw, 8px)'
          }}
        >
          {/* Part tabs */}
          <div className="flex items-center shrink-0" style={{ gap: 'clamp(1px, 0.5vw, 4px)' }}>
            <span className="font-black text-slate-400 uppercase tracking-wider whitespace-nowrap hidden sm:inline landscape:hidden portrait:hidden" style={{ fontSize: 'clamp(8px, 1.8vw, 10px)' }}>CHỌN PART:</span>
            {[1, 2, 3, 4, 5, 6, 7].map(p => (
              <button
                key={p}
                onClick={() => setActivePart(p)}
                className={`rounded-md font-black transition-all ${
                  activePart === p
                    ? "bg-blue-600 text-white shadow-xs"
                    : "text-slate-500 hover:bg-slate-100 hover:text-slate-700"
                }`}
                style={{
                  fontSize: 'clamp(7.5px, 2.2vw, 10px)',
                  padding: 'clamp(1px, 0.2vh, 2px) clamp(3px, 1vw, 7px)',
          ...
          <div className="bg-slate-200 shrink-0" style={{ width: '1px', height: 'clamp(10px, 1.8vh, 16px)' }}></div>

          {/* Clock - inline editor */}
          <div className="relative flex items-center shrink-0" style={{ gap: 'clamp(2px, 0.5vw, 4px)' }}>
            {!showTimePicker ? (
              <button
                ...
                className={`flex items-center rounded-xl transition-all group ${
                  timeLeft < 300 ? "bg-red-100 text-red-600 shadow-xs" : "bg-blue-50 hover:bg-blue-100 text-blue-600 shadow-xs border border-blue-100/50"
                }`}
                style={{
                  height: 'clamp(16px, 2.4vh, 24px)',
                  padding: 'clamp(1px, 0.2vh, 2px) clamp(3px, 1vw, 8px)',
                  gap: 'clamp(2px, 0.5vw, 4px)'
                }}
                title="Click để đặt thời gian"
              >
                <Clock className={timeLeft < 300 ? "animate-pulse" : ""} style={{ width: 'clamp(9px, 2.5vw, 13px)', height: 'clamp(9px, 2.5vw, 13px)' }} />
                <span className={`font-black font-mono ${timeLeft < 300 ? "text-red-600" : "text-slate-700"}`} style={{ fontSize: 'clamp(8px, 2.4vw, 12px)' }}>
                  {formatTime(timeLeft)}
                </span>
                <span className="text-slate-400 font-bold whitespace-nowrap ml-1 hidden xs:inline portrait:hidden" style={{ fontSize: 'clamp(6.5px, 1.6vw, 9px)' }}>Đặt lại</span>
              </button>
            ) : (
