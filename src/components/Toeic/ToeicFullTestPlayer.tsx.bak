          ...
          const attempts = allQuestions
            ...
            .map(q => {
              ...
              return {
                ...
                userAnswer: userAns,
                isCorrect: isCorrect,
                isFlagged: prog.isFlagged || false,
                flagColor: prog.flagColor || null,
                flagNote: prog.flagNote || null
              };
            });
            ...
            <div className="relative w-full min-h-[calc(100vh-250px)] bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden">
              {activePart === 1 && (
                <ToeicPart1Player
                  ...
                  onToggleFlag={(flag: boolean, color?: FlagColor | null, note?: string) => {
                    if (activeQuestionNo) {
                      handleUpdateProgress({ [activeQuestionNo]: { isFlagged: flag, flagColor: color || null, flagNote: note } });
                    }
                  }}
